...
class DialogflowResponse {
    ...
    getSessionAttributes() {
        const sessionContext = _get(this, 'outputContexts').find((context) => {
    ...
    getSpeech() {
        ...
        return jovo_core_1.SpeechBuilder.removeSpeakTags(this.fulfillmentText);
    }
    getReprompt() {
        const platformId = this.getPlatformId();
        if (this.payload && platformId) {
    ...
    hasState(state) {
        ...
        if (sessionContext) {
            return _get(sessionContext, `parameters.${jovo_core_1.SessionConstants.STATE}`) === state;
        }
        return false;
    }
