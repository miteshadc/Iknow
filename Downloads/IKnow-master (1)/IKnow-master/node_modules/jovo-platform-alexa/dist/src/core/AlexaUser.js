...
class AlexaUser extends jovo_core_1.User {
    ...
    getName() {
        const alexaRequest = this.alexaSkill.$request;
        return AlexaContact_1.AlexaContact.contactAPI(AlexaContact_1.AlexaContact.NAME, alexaRequest.getApiEndpoint(), alexaRequest.getConsentToken());
    }
    /**
     * Returns name of user, if granted
     * @return {Promise}
    ...
    getEmail() {
        const alexaRequest = this.alexaSkill.$request;
        return AlexaContact_1.AlexaContact.contactAPI(AlexaContact_1.AlexaContact.EMAIL, alexaRequest.getApiEndpoint(), alexaRequest.getConsentToken());
    }
    /**
    ...
    getGivenName() {
        const alexaRequest = this.alexaSkill.$request;
        return AlexaContact_1.AlexaContact.contactAPI(AlexaContact_1.AlexaContact.GIVEN_NAME, alexaRequest.getApiEndpoint(), alexaRequest.getConsentToken());
    }
    /**
    ...
    getMobileNumber() {
        const alexaRequest = this.alexaSkill.$request;
        return AlexaContact_1.AlexaContact.contactAPI(AlexaContact_1.AlexaContact.MOBILE_NUMBER, alexaRequest.getApiEndpoint(), alexaRequest.getConsentToken());
    }
    /**
