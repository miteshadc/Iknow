...
class Display {
    install(alexa) {
         ...
         * @public
         */
        AlexaSkill_1.AlexaSkill.prototype.deleteShouldEndSession = function () {
    ...
    output(alexaSkill) {
        ...
        if (alexaSkill.$request.hasScreenInterface()) {
            if (_get(output, 'Alexa.DisplayTemplate')) {
                _set(response, 'response.directives', [_get(output, 'Alexa.DisplayTemplate')]);
            }
            if (_get(output, 'Alexa.DisplayHint')) {
                if (!_get(response, 'response.directives')) {
                    _set(response, 'response.directives', [_get(output, 'Alexa.DisplayHint')]);
                }
                else {
            ...
            if (_get(output, 'Alexa.VideoApp')) {
                ...
                _set(response, 'response.directives', [_get(output, 'Alexa.VideoApp')]);
