...
class ProactiveEvent {
    ...
    async sendProactiveEvent(proactiveEvent, accessToken, live = false) {
        if (!accessToken) {
            throw new jovo_core_2.JovoError('Can\'t find accessToken', jovo_core_1.ErrorCode.ERR, 'jovo-platform-alexa', 'To send out Proactive Events you have to provide an accessToken', 'Try to get an accessToken by calling "this.$alexaSkill.$proactiveEvents.getAccessToken(clientId, clientSecret)"');
        }
