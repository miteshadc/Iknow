...
class Dialogflow extends jovo_core_1.Extensible {
    constructor(config) {
        super(config);
        this.requestBuilder = new DialogflowRequestBuilder_1.DialogflowRequestBuilder();
        this.responseBuilder = new DialogflowResponseBuilder_1.DialogflowResponseBuilder();
        this.config = {
            enabled: true,
        };
        if (config) {
    ...
    makeTestSuite() {
        return new jovo_core_1.TestSuite(new DialogflowRequestBuilder_1.DialogflowRequestBuilder(), new DialogflowResponseBuilder_1.DialogflowResponseBuilder());
    }
    install(app) {
