...
class GoogleAssistant extends jovo_core_1.Extensible {
    ...
    install(app) {
        ...
        this.use(new GoogleAssistantCore_1.GoogleAssistantCore(), new Cards_1.Cards(), new AskFor_1.AskFor(), new MediaResponse_1.MediaResponsePlugin(), new Transaction_1.TransactionsPlugin());
    ...
    initDialogflow() {
        this.use(new jovo_platform_dialogflow_1.DialogflowNlu({
            platformRequestClazz: GoogleActionRequest_1.GoogleActionRequest,
            platformClazz: GoogleAction_1.GoogleAction,
            platformResponseClazz: GoogleActionResponse_1.GoogleActionResponse,
            platformId: 'google'
        }));
    }
    async initialize(handleRequest) {
        handleRequest.platformClazz = GoogleAction_1.GoogleAction;
